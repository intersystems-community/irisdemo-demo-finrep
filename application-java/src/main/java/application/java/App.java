...
public class App {
	...
	public static Gateway connect() throws Exception{
		...
		// load a CCP
		Path networkConfigPath = Paths.get("..", "..", "..", "hyperledger", "organizations", "peerOrganizations", "org1.example.com", "connection-org1.yaml");
	...
	public static void main(String[] args) throws Exception {
		...
		try (Gateway gateway = connect()) {
			...
			//CreateAsset creates an asset with ID asset13, color yellow, owner Tom, size 5 and appraisedValue of 1300
			contract.submitTransaction("createPSD001", "report1", "2020-09-28", "<xml>Test<xml>", "ISC", "Sales");
			...
			System.out.println("\n");
			System.out.println("Evaluate Transaction: AssetExists report2");
			// AssetExists returns "true" if an asset with given assetID exist
			result = contract.evaluateTransaction("PSD001Exists", "report2");
			System.out.println("result: " + new String(result));
